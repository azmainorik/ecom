                ...
                <div class="ibox-body">
                    ...
                    <div class="row">
                            <div class="col-sm-6 form-group">
                                ...
                                <input class="form-control" value="{{$category->name}}" name="name" type="text" placeholder="category Name">
                            </div>
                            <div class="col-sm-6 form-group">
                                <label>Category description</label>
                                <textarea name="description" class="form-control" name="description" type="text" placeholder="Category Description" id="" cols="60" rows="10">{{$category->description}}</textarea>
                            </div>
                        </div>
