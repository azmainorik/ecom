	                ...
	                <div class="container">
						<form action="{{route('order.new')}}" method="POST">
							@csrf
            			 	<div class="row">
		                		<div class="col-lg-9">
		                			<h2 class="checkout-title">Please fill up the forms</h2><!-- End .checkout-title -->
	        							...
	        							<textarea class="form-control" cols="30" rows="4" placeholder="please give your address" name="delivery" class="form-control" required></textarea>
		                		</div><!-- End .col-lg-9 -->
