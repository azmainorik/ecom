...
Route::get('/delete-brand-category/{id}', [
...
//brand category route end


//unit category route start
...
Route::get('/get-sub-category-by-id', [
    ...
    'as'        => 'product.get-sub-category-id',
    'middleware'=>['auth:sanctum', 'verified']
]);
